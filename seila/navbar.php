    ...
    <nav class="container navbar">
            ...
            <?php if (is_logged_in()): ?>
                ...
                <div class="user-buttons-container">
                    <?php
                        ...
                        $photoSrc = $isValidPhoto ? ('perfil_foto/' . htmlspecialchars($photo)) : 'perfil_foto/default-avatar.png';
                        $userName = isset($_SESSION['user_name']) ? htmlspecialchars((string)$_SESSION['user_name']) : 'Usuário';
                    ?>
        ...
        <button class="mobile-menu-button" aria-label="Abrir menu" onclick="(function(){
            ...
            if (links.style.display === 'flex') {
                ...
                links.style.background = 'rgba(17, 24, 39, 0.95)';
                links.style.padding = '12px 16px';
                links.style.borderRadius = '12px';
                links.style.gap = '8px';
                links.style.boxShadow = '0 10px 30px rgba(0,0,0,0.35)';
            }
        })()">
