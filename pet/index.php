...
try {
    // Modificado para buscar apenas aprovados
    $stmt = $pdo->query("SELECT * FROM animais WHERE status = 'aprovado' ORDER BY data_cadastro DESC LIMIT 4");
...
<head>
    ...
    <style>
        ...
        /* Responsividade - removida, usando style.css principal */
    </style>
</head>
<body>
