        ...
        <section class="about-section">
            <div class="container about-container">
                ...
                <div class="team-section reveal">
                    <h2 class="section-title">A Nossa Equipe</h2>
                    <div class="team-grid">
                        <div class="team-member reveal">
                            <img src="ceo 3.jpg" alt="Foto de um membro da equipa" loading="lazy" width="150" height="150">
                            <h4>Sandro Hélio</h4>
                            <span>Organizador & Coordenador</span>
                        </div>
                        <div class="team-member reveal">
                        ...
                        <div class="team-member reveal">
                            <img src="ceo 2.jpg" alt="Foto de um membro da equipa" loading="lazy" width="150" height="150">
                            <h4>Kaik Oliveira da Silva Paulino</h4>
                            <span>Fundador & Sócio</span>
                        </div>
                    </div>
                </div>
            </div>
