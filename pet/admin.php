...
try {
    $stmt_usuarios = $pdo->query("SELECT id, nome, email, nivel_acesso, data_registro FROM usuarios ORDER BY nome ASC");
             ...
             <div id="tab-usuarios" class="tab-content <?php echo $tab == 'usuarios' ? 'active' : ''; ?>">
                <div class="content-card">
                    <div class="section-header">
                        ...
                        <!-- <a href="criar_usuario.php" class="btn btn-register">➕ Novo Utilizador</a> -->
                    </div>
                    ...
                    <div class="items-list">
                        ...
                        <?php else: ?>
                            <?php foreach ($usuarios as $usuario): ?>
                                <div class="item">
                                    <div class="item-info">
                                         <!-- Pode adicionar a foto de perfil aqui se desejar -->
                                         <div class="item-photo" style="background: var(--dark-bg); display: flex; align-items: center; justify-content: center; font-size: 1.5rem; color: var(--text-color-light); border-radius: 50%;"><i class="fas fa-user"></i></div>
                                        <div class="item-details">
